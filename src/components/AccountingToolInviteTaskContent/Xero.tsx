...
export function XeroOptionContentPage1({
    ...
    <TaskSectionContainer>
        ...
        <Flex direction="row" gap="1">
          <Flex direction="column" gap="3">
            <label>
              ...
              <TextField.Root radius="full" defaultValue="Novabook" disabled>
                <TextField.Slot />
                <TextField.Slot>
                  <IconButton
                    size="1"
                    variant="ghost"
                    color="gray"
                    onClick={() => navigator.clipboard.writeText("Novabook")}
                  >
          ...
          <Flex direction="column" gap="3">
            <label>
              ...
              <TextField.Root radius="full" defaultValue="Books" disabled>
                <TextField.Slot />
                <TextField.Slot>
                  <IconButton
                    size="1"
                    variant="ghost"
                    color="gray"
                    onClick={() => navigator.clipboard.writeText("Books")}
                  >
                    <CopyIcon height="14" width="14" />
                  </IconButton>
                </TextField.Slot>
      ...
      <Table.Root className="rounded-xl overflow-hidden border border-[var(--novaBlack-5)]">
        <Table.Body>
          <Table.Row>
            <Table.RowHeaderCell>
              Enable "Projects" and select "Admin".
            </Table.RowHeaderCell>
          </Table.Row>
          <Table.Row>
          ...
          <Table.Row>
            <Table.RowHeaderCell>
              <Flex direction="column" gap="1">
                <Text>
                  Enable "Business and accouting" and select "Advisor".
                </Text>
                <Text>Under "Advisor", enable.</Text>
                <Flex direction="column" gap="1" className="ml-2">
                  <Text>• Bank account admin</Text>
                  <Text>• File MTD VAT return</Text>
      ...
      >
        <CheckboxCards.Item value="2">
          I confirm I have ainvited Novabook and enabled correct permissions.
        </CheckboxCards.Item>
      </CheckboxCards.Root>
    </TaskSectionContainer>
  );
}
export function XeroOptionContentPage2({
  handleCheckboxChange,
}: PageContentProps) {
  return (
    <div className="space-y-6">
      ...
      <TaskSectionContainer>
        ...
        >
          <CheckboxCards.Item value="2">
            I confirm I have listed any bankl accounts that could not be
            connected to Xero.
          </CheckboxCards.Item>
        </CheckboxCards.Root>
      </TaskSectionContainer>
