...
import { Card, CheckboxCards, Flex, IconButton, Text, TextArea, TextField } from "@radix-ui/themes"
import { CopyIcon } from "@radix-ui/react-icons"

export function QuickBooksOptionContentPage1({handleCheckboxChange}: PageContentProps) {
    return(
...
export function QuickBooksOptionContentPage2({handleCheckboxChange}: PageContentProps ) {
